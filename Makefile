...
FLIT_INC_DIR    := /usr/include
FLIT_SRC_DIR    := /usr/share/flit/src
FLIT_SRC        := $(FLIT_SRC_DIR)/ALL-FLIT.cpp
FLIT_DATA_DIR   := /usr/share/flit/data
FLIT_SCRIPT_DIR := /usr/share/flit/scripts

DEV_CXX         := ./nvcc-wrapper.py
DEV_CXX_TYPE    := nvcc
DEV_OPTL        := -O3
DEV_SWITCHES    := 

GT_CXX          := ./nvcc-wrapper.py
GT_CXX_TYPE     := nvcc
GT_OPTL         := -O2
GT_SWITCHES     := 
...
GT_CXXFLAGS     := $(NVCC_CXXFLAGS)
GT_LDFLAGS      := $(NVCC_LDFLAGS)
DEV_CXXFLAGS    := $(NVCC_CXXFLAGS)
DEV_LDFLAGS     := $(NVCC_LDFLAGS)

RUNWRAP          = $(RUN_WRAPPER)

ENABLE_MPI      := yes
CXXFLAGS        += -Wl,-z,relro -I/usr/include/x86_64-linux-gnu/mpich -L/usr/lib/x86_64-linux-gnu -lmpichcxx -lmpich
LDFLAGS         += -Wl,-z,relro -I/usr/include/x86_64-linux-gnu/mpich -L/usr/lib/x86_64-linux-gnu -lmpichcxx -lmpich
